...
fun MeshGradientBackdrop(modifier: Modifier = Modifier) {
    ...
    Canvas(modifier = modifier.fillMaxSize().background(Color(0xFF050307))) {
        ...
        drawBlob(
            centerX(0.65f, 0.05f, t * (60f / 47f)),
            centerY(0.30f, 0.04f, t * (60f / 47f)),
            Color(0xFFF3A280).copy(alpha = 0.55f),
        )
        drawBlob(
            centerX(0.20f, 0.06f, t * (60f / 53f)),
            centerY(0.75f, 0.05f, t * (60f / 53f)),
            Color(0xFFB46CC4).copy(alpha = 0.50f),
        )
        drawBlob(
            centerX(0.80f, 0.04f, t * (60f / 61f)),
            centerY(0.90f, 0.03f, t * (60f / 61f)),
