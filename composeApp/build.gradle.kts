...
abstract class GenerateBuildInfoTask : DefaultTask() {
    ...
    @get:Input
    abstract val buildEpochSeconds: Property<Long>
    ...
    @TaskAction
    fun generate() {
        val rootFile = gitRoot.get().asFile
        ...
        pkgDir.resolve("BuildInfo.kt").writeText(
            ...
            object BuildInfo {
                ...
                const val BUILD_EPOCH_S: Long = ${buildEpochSeconds.get()}L
            }
            """.trimIndent() + "\n"
        )
    }
...
val generateBuildInfo by tasks.registering(GenerateBuildInfoTask::class) {
    ...
    buildEpochSeconds.set(resolvedBuildEpoch)
